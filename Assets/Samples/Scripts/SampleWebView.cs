...
public class SampleWebView : MonoBehaviour
{
    ...
    void AddButtonsCallBack() {
        B.onClick.AddListener(()=>{
            bool canGoBack = (webViewObject == null) ? false : webViewObject.CanGoBack();
            if (canGoBack)
            {
        ...
        F.onClick.AddListener(() => {
            bool canGoForwaed = (webViewObject == null) ? false : webViewObject.CanGoForward();
            if (canGoForwaed)
            {
        ...
        R.onClick.AddListener(() => {
            bool canReload = (webViewObject == null);
            if (canReload)
            {
